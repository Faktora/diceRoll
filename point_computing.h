 ...
 * after getting the min and max goes thru player_throws to find if all numbers are consecutive*/
 ...
 /// \fn is_consecutive - takes array with player's throws returns true if elements are consecutive, false otherwise;
...
/// \fn is_max - searches the array with player throws for the max element in it
int is_min(const int player_throws[], int array_throws_length);//finds the min element in the array
/// \fn is_min - searches the array with player throws for the min element in it
...
/// \fn is_fullhouse - takes a sorted player's throws array from is_highest and returns true if three and two of a
...
/// \fn is_grande - checks the player's throw array if all dices are Aces
...
/// \fn is_poker - takes the sorted player's throws array and returns true if there are four of a kind, false otherwise
bool is_poker();

/*takes the array and sorts it by power in search for poker and full house*/
/// \fn is_highest - takes the array as argument and sorts it by power
void is_highest();
